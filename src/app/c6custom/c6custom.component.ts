...
@Component({
  selector: 'app-c6custom',
  templateUrl: './c6custom.component.html',
  styleUrls: ['./c6custom.component.css']
})
export class C6customComponent implements OnInit {

  constructor() { }
  username:string="Sharvan Saini lives in smk";
  emp: any[] = [
    {
      EMPNO: 7369,
      ENAME: 'SMITH',
